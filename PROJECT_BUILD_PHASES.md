...
1. Setup → 2. DB connection → 3. Schema → 4. Schemas → 5. Security → 6. Auth → 7. CRUD → 8. JWT/RBAC → 9. Admin → 10. Products → 11. Favorites → 12. Cart → 13. Orders → 14. Cross-cutting → 15. Tests → 16. Frontend setup → 17. Frontend auth/routing → 18. Frontend pages.
