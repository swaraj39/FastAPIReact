...
import { buildMcpToolErrorResponse, buildMcpToolSuccessResponse, buildSandboxErrorResponse, convertErrorToJson, getOutputFilePath, requiresSecretScan, } from './mcpToolRuntime.js';
...
export const registerGrepRepomixOutputTool = (mcpServer, config = { sandboxed: false, root: process.cwd() }) => {
    mcpServer.registerTool('grep_repomix_output', {
        ...
        try {
            ...
            try {
                ...
                logger.error(`Error in grep_repomix_output search: ${error}`);
                if (config.sandboxed)
                    return buildSandboxErrorResponse(error, outputId);
                return buildMcpToolErrorResponse({
