...
export declare class OperationCancelledError extends RepomixError {
    constructor(message?: string);
}
export declare const handleError: (error: unknown) => void;
export declare const rethrowValidationErrorIfSchemaError: (error: unknown, message: string) => void;
