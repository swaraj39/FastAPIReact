...
const getFileChangeCounts = async (cwd, maxCommits, deps) => {
...
const checkGitAvailability = async (cwd, deps) => {
...
export const sortOutputFiles = async (files, config, deps = {
    getFileChangeCount,
    isGitInstalled,
}) => {
...
export const prefetchSortData = async (config, deps = {
    getFileChangeCount,
    isGitInstalled,
}) => {
    if (!config.output.git?.sortByChanges)
